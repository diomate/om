    ...
    return <div className={css.navbar}>
        ...
        <div className={css.navbarInner}>
            ...
            <div className={css.rightSide}>
                {page !== 'add-restaurant' ? <Link to='#' className={css.menuItem} >Add restuarant</Link> : ''}
                {loggedIn ? (<div className={css.menuItem}>
                    ...
                    <div className={css.menuItem} onClick={() => setAuth({ closed: false, login: false, signup: false })}>Log in</div>
                    <div className={css.menuItem} onClick={() => setAuth({ closed: false, login: false, signup: false })}>Sign up</div>
                </>)}
            </div>
        </div>
